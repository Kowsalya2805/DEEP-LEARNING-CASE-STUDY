# Case Study 3: Spam Email Classifier – Hyperparameter Tuning & Regularization
# Ready for GitHub Codespace or Colab execution
...
# ----------------------------------------------------------------------
print("\n✅ Overfitting Reduced – Model now generalizes better using regularization & tuned hyperparameters.")